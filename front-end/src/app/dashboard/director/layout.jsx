...
const ITEMS = [
  ...
  { tkey: "rh", label: "Suivi RH", href: "/dashboard/director/rh", icon: <ClipboardList size={18} />, manager: true },
  ...
  { tkey: "residence", label: "Résidence", href: "/dashboard/director/residence", icon: <MapPin size={18} /> },
