...
import { Home, MessageSquare, KeyRound, LibraryBig, ShieldAlert, Megaphone } from "lucide-react";
...
const ITEMS = [
  ...
  { tkey: "convocations", label: "Convocations", href: "/dashboard/autres/convocations", icon: <Megaphone size={18} /> },
